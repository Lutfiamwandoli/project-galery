...
if ($_SESSION['status'] != 'login') {
    ...
    exit; // tambahkan ini untuk menghentikan eksekusi skrip jika belum login
}

$userid = $_SESSION['userid']; // pindahkan inisialisasi userid ke atas include koneksi
            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="from-label">Album</label>
                        <select class="form-control" name="albumid">
                            ...
                            <?php } ?>
                        <label class="from-label">File</label>
      ...
      <div class="modal-body">
        <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <label class="from-label">Ganti File</label>
